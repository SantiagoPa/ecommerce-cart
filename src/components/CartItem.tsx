...
export const CartItem = ({ product }: Props) => {
    ...
    const { onMinusItemQuantity, onPlusItemQuantity } = useCart();
    ...
    return (
        <article className="flex flex-row bg-gray-50 p-2 border-2 border-gray-200 rounded-lg justify-center items-center gap-2 mx-2">
            ...
            <div className="flex flex-row justify-center items-center gap-2">
                <button className="cursor-pointer bg-red-600 rounded-md" 
                    onClick={()=>onMinusItemQuantity(product)}
                >
                ...
                <button 
                    className="cursor-pointer bg-green-600 rounded-md"
                    onClick={()=>onPlusItemQuantity(product)}
                >
